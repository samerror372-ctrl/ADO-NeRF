...
class EMAModel:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.ema_decay_step = kwargs.get("ema_decay_step", 10)
    ...
    ### we have to re-send new model here for ema_model
    def save_pretrained(self, model, path):
        ...
        torch.save(state_dict, path.replace(".pt", "_params.pt"))
    ...
    def get_decay(self, optimization_step: int) -> float:
        ...
        if self.use_ema_warmup:
            ...
            cur_decay_value = (1 + step) / (self.ema_decay_step + step)

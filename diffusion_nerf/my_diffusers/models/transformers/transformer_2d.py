        ...
        for block in self.transformer_blocks:
            if self.training and self.gradient_checkpointing:
                ...
                def create_custom_forward(module, return_dict=None):
                    def custom_forward(*inputs, nframe=None, coords_feat=None, image_rotary_emb=None,
                                       cond_num=None, key_rescale=None):
                        if return_dict is not None:
                            return module(*inputs, return_dict=return_dict, nframe=nframe,
                                          coords_feat=coords_feat, image_rotary_emb=image_rotary_emb,
                                          cond_num=cond_num, key_rescale=key_rescale)
                        else:
                            return module(*inputs, nframe=nframe, coords_feat=coords_feat,

...
from utils import _resize_pil_image, _resize_np_image, _seq_name_to_seed, process_prompt, load_16big_png_depth
...
class DL3DVDataset(Dataset):
    ...
    def load_camera(self, fname):
        camera_path = os.path.join("/".join(fname.split("/")[:-2]), "opencv_camera_4.json")

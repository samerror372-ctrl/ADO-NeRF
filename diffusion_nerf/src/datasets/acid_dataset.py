...
class ACIDDataset(Dataset):
    def __init__(self, dataset_root, data_list, nframe, height, width,
        ...
        super(ACIDDataset, self).__init__()
        ...
        self.global_seq_dict = pickle.load(open("./data/acid/global_seq_dict.pkl", "rb"))
        self.total_num = 0
        with open(data_list, "r") as f:
            for line in tqdm(f, desc=f"loading global acid {mode} sequences...", disable=rank != 0):
